...
__DEFINE__(1676024131091, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1676024131092,"./event-store":1676024131093}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1676024131092, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1676024131093, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1676024131092,"./utils":1676024131094}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1676024131094, function(require, module, exports) {
...
return __REQUIRE__(1676024131091);
})()
